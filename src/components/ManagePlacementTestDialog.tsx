  ...
  const saveQuestionsMutation = useMutation({
    mutationFn: async () => {
      ...
      const questionsToInsert = editingQuestions.map((q, index) => ({
        ...
        option_a: q.question_type === 'text' ? (q.option_a || null) : null,
        option_b: q.question_type === 'text' ? (q.option_b || null) : null,
        option_c: q.question_type === 'text' ? (q.option_c || null) : null,
        option_d: q.question_type === 'text' ? (q.option_d || null) : null,
        correct_answer: q.question_type === 'text' ? (q.correct_answer ? q.correct_answer.toUpperCase() : null) : null,
