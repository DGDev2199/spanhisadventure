...
const Dashboard = () => {
  ...
  const showVideoCallOptions = useMemo(
    () => isVideoCallsEnabled && isOnlineStudent,
    [isVideoCallsEnabled, isOnlineStudent],
  );
  ...
  const handleTutorChat = useCallback(() => {
    if (tutorProfile) {
      setChatStaff({
        ...
        avatar: tutorProfile.avatar_url,
        role: "tutor",
      });
      setChatOpen(true);
    }
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8 safe-bottom">
        ...
        <div className="mb-4 sm:mb-6 lg:mb-8 animate-fade-in">
          ...
          <p className="text-sm sm:text-base text-muted-foreground">
            {isOnlineStudent ? t("dashboard.onlineStudentMessage") : t("dashboard.presencialStudentMessage")}
          </p>
        </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {teacherProfile && tutorProfile ? t("dashboard.alreadyAssigned") : t("dashboard.exploreProfiles")}
                    </p>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          {!isOnlineStudent && (
            <Card className="shadow-md">
              <CardHeader>
                ...
                <CardDescription>{t("dashboard.viewScheduleDesc")}</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">{t("dashboard.checkSchedule")}</p>
          ...
          <Card className="shadow-md">
            <CardHeader>
              ...
              <CardDescription>{t("dashboard.viewUpdateInfo")}</CardDescription>
            </CardHeader>
            <CardContent>
      ...
      {user?.id && (
        <>
          <ClassScheduleDialog open={classScheduleOpen} onOpenChange={setClassScheduleOpen} studentId={user.id} />
