-- Create a secure view for staff to see bookings without sensitive financial data
-- Staff should only see their own earnings, not price/platform_fee details

CREATE OR REPLACE VIEW public.staff_bookings_view AS
SELECT 
    id,
    student_id,
    teacher_id,
